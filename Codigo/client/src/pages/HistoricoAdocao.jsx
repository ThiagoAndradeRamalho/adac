...
const HistoricoAdocao = () => {
    ...
    const fetchPetById = async (petId) => {
        try {
            const response = await fetch(`https://adacc.onrender.com1/api/pet/${petId}`);
    ...
    const fetchAdotanteById = async (usuarioId) => {
        try {
            const response = await fetch(`https://adacc.onrender.com0/api/usuario/${usuarioId}`);
            if (!response.ok) throw new Error(`HTTP error: ${response.status}`);
        ...
        const fetchAdocoes = async () => {
            ...
            try {
                const response = isAdmin
                    ? await fetch('https://adacc.onrender.com1/api/adocao/')
                    : await fetch(`https://adacc.onrender.com1/api/adocao/usuario/${userLoggedIn.id}`);
    ...
    const handleOk = async (values) => {
        ...
        try {
            const response = await fetch(`https://adacc.onrender.com1/api/adocao/${selectedAdocao.id}`, {
                method: 'PUT',
                headers: {
